        ...
        <div className="container m-auto">
          ...
          <div className="flex flex-col mt-10 gap-20">
            {portfolioProjects.map((project) => (
              <div
                key={project.title}
                className="bg-gray-800 rounded-3xl overflow-hidden relative z-0 after:z-10 after:content-[''] after:absolute after:inset-0 after:outline-2 after:-outline-offset-2 after:rounded-3xl after:outline-white/20 pt-8 px-8 mx-2 after:pointer-events-none"
              >
                ...
                <ul className="flex flex-col gap-3 mt-4">
                  {project.results.map((result) => (
                    <li className="flex gap-2 text-sm text-white/52">
